...
// Compile compiles an ast.StmtNode to a ast.Statement.
// The ast.StmtNode is Preprocessed and Validated, then Optimized to a plan,
// and finally wrappped to an adapter *statement as stmt.Statement.
